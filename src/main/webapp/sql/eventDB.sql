...
alter table post_test
    modify p_img varchar2(400);
alter table post_test
    modify p_actor varchar2(500 char);

create sequence post_test_seq;
insert into post_test
values (post_test_seq.nextval, '제목1', '~와의 콜라보',
        'https://mblogthumb-phinf.pstatic.net/MjAyMTA1MTFfNjMg/MDAxNjIwNzEzODM3ODcz.jOj9ZysGMuhxRxycIBMsInB5fqKdOyMEa1DMiLwkDuEg.vKI42FzscRSTq01KwN5LPMB5UILU3gsKqV0Ry7VMFysg.JPEG.bluenight457/%EA%B7%80%EB%A9%B8%EC%9D%98_%EC%B9%BC%EB%82%A0_x_%EB%A1%9C%EC%86%90_%EC%BA%A0%ED%8E%98%EC%9D%B8.jpg?type=w420',
        'ㄴㄴ', sysdate);
insert into post_test
values (post_test_seq.nextval, '제목2', '~와의 콜라보',
        'https://mblogthumb-phinf.pstatic.net/MjAyMTA1MTFfNjMg/MDAxNjIwNzEzODM3ODcz.jOj9ZysGMuhxRxycIBMsInB5fqKdOyMEa1DMiLwkDuEg.vKI42FzscRSTq01KwN5LPMB5UILU3gsKqV0Ry7VMFysg.JPEG.bluenight457/%EA%B7%80%EB%A9%B8%EC%9D%98_%EC%B9%BC%EB%82%A0_x_%EB%A1%9C%EC%86%90_%EC%BA%A0%ED%8E%98%EC%9D%B8.jpg?type=w420',
        'ㄴㄴ', sysdate);
insert into post_test
values (post_test_seq.nextval, '제목3', '~와의 콜라보',
        'https://mblogthumb-phinf.pstatic.net/MjAyMTA1MTFfNjMg/MDAxNjIwNzEzODM3ODcz.jOj9ZysGMuhxRxycIBMsInB5fqKdOyMEa1DMiLwkDuEg.vKI42FzscRSTq01KwN5LPMB5UILU3gsKqV0Ry7VMFysg.JPEG.bluenight457/%EA%B7%80%EB%A9%B8%EC%9D%98_%EC%B9%BC%EB%82%A0_x_%EB%A1%9C%EC%86%90_%EC%BA%A0%ED%8E%98%EC%9D%B8.jpg?type=w420',
        'ㄴㄴ', sysdate);
select *
from post_test;
...
(
    ...
    e_title       varchar2(300 char)  not null,
...
ALTER TABLE review_test
    MODIFY r_text VARCHAR2(200);
ALTER TABLE review_test
    MODIFY r_sub varchar2(200);
alter table review_test
    modify r_img varchar2(1000);
ALTER TABLE review_test
    MODIFY r_sub VARCHAR2(200);
ALTER TABLE review_test
    MODIFY r_text VARCHAR2(200);
...
values (review_test_seq.nextval, '세븐일레븐', 'mr.greenapple',
        'https://www.lawson.co.jp/lab/campaign/mrsgreenapple/img/main_keyvisual01.png', 'mr.greenapple과의 콜라보',
