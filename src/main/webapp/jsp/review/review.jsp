...
<section class="event-form-section"
	...
	<!-- 리뷰 등록 폼 -->
	<div class="movie-form-container" style="flex: 1; min-width: 300px; height: 500px; display: flex; flex-direction: column; justify-content: space-between;">
		<form action="resultRegC" method="post" enctype="multipart/form-data">
			<div class="movie-form">
				...
				<div class="form-group">
					...
					<input id="Name" name="Name" type="text" placeholder="商品名" required>
				</div>
				...
				<div class="form-group">
					...
					<textarea id="story" name="story" rows="5" maxlength="200" placeholder="商品説明" required></textarea>
				</div>
	...
	<div class="product-list-container" style="flex: 1; min-width: 500px; height: 500px; display: flex; flex-direction: column; justify-content: space-between; text-align: center;">
		<h1>商品目録</h1>
